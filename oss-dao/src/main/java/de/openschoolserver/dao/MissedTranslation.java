...
@NamedQueries({
	...
	@NamedQuery(name="MissedTranslation.findByLang",query="SELECT t FROM Translation t WHERER t.lang := lang"),
	@NamedQuery(name="MissedTranslation.find",		query="SELECT t FROM Translation t WHERER t.lang := lang AND t.string = :string")
})
